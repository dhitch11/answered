...
<section class="paper seam pad" id="interest" data-aud="consumer business both">
  <div class="wrap narrow">
    ...
    <!-- ★ THE FORM STAYS, DEMOTED, AND THAT IS DELIBERATE. David's ruling was that the front door
         must not go to a waitlist, and it no longer does: the primary path is a text thread that
         actually provisions an account. But a CONSUMER on /hold is not setting up a contractor
         line and has nothing to text SETUP about, so removing the form entirely would strand the
         other half of the product. Primary path first, quiet second path underneath. -->
    <p class="src rv d2" style="margin-top:34px;text-align:center;margin-inline:auto;max-width:54ch">Not setting up a business line, or would rather use email? Tell us what you need and a person reads it.</p>
