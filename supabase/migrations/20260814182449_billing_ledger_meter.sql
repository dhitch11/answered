-- 20260814182449_billing_ledger_meter
...
comment on column public.billing_events.idem_key is
  'The caller handle on this outcome, usually a call sid or a deal id. The unique index is the whole idempotency story: a retried webhook cannot bill twice.';
comment on column public.billing_events.rating is
  'The complete rating as the engine produced it, frozen. A bill is never re-derived from today price book.';
